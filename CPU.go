...
func exec(rom []string, addr string) (string, bool) {
...
func execInstr(rom []string, instr string, normalizedPointer string, orig string) (string, bool) {
